...
export function AssetDrawer({ asset, findings, detectors, onClose }: { asset: Asset | null; findings?: Finding[]; detectors?: DetectorMeta[]; onClose: () => void }) {
  ...
  return (
    ...
    >
      {asset ? <AssetDetailPanel asset={asset} findings={findings} detectors={detectors} /> : null}
    </Drawer>
  )
}
